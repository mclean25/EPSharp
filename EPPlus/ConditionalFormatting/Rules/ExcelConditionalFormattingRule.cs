      ...
      : base(
                ...
                if (priority != value)
                {
                    ...
                    if (!_changingPriority)
                    {
                        ...
                        if (priority > value)
                        {
                            ...
                            {
                                var cfRule = Worksheet.ConditionalFormatting.RulesByPriority(i);
        ...
        public ExcelDxfStyleConditionalFormatting Style
        {
            get
            {
                if (_style == null)
                {
                    _style = new ExcelDxfStyleConditionalFormatting(NameSpaceManager, null, Worksheet.Workbook.Styles);
                }
                return _style;
            }
        }
